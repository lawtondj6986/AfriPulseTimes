# AfriPulse Times — Investor Brief

_Series Seed · 2026. One-page brief + deck outline. Pair with
[`INVESTOR_READINESS.md`](./INVESTOR_READINESS.md) (product status) and
[`DEMO_DAY_RUNBOOK.md`](./DEMO_DAY_RUNBOOK.md) (how to run the live demo)._
...
African news is **fragmented by country and by language**, and too often the
continent's story is told from the outside. A reader in Lagos, Nairobi, Cairo, or
Dakar has no single, credible, real-time source for the whole continent in their
own language. Advertisers who want pan-African reach have no unified premium
surface to buy.
...
- A full editorial admin (magic-link login): create/edit/publish, image upload,
  and an investor-enquiry CRM.
- Investor contact capture → database + instant email alerts.
- Built on Supabase + Vercel: **infrastructure costs cents/day and scales to the
  whole continent.**
...
Today this is a **live, working proof-of-concept** built by a mission-driven,
non-technical founder who shipped it end-to-end. We are pre-revenue and pre-scale;
the raise funds the leap from proof-of-concept to operating newsroom. _(Fill in any
real numbers you have: pilot readers, newsletter signups, LOIs, advertiser
conversations.)_

## The ask — Series Seed 2026

**Raising $____** to fund, over ~12 months:
- **Engineering** — server-side rendering + real per-article URLs (SEO/shareability),
  reader accounts, analytics.
- **Editorial** — an editorial lead + stringers across the first launch markets;
  move from aggregation toward original reporting.
- **Growth** — audience acquisition and advertiser pipeline in 3–5 launch markets.

Milestone target: _[e.g., X monthly readers, Y newsletter subscribers, first
advertising revenue] within [N] months._
...
| Risk | Mitigation |
|---|---|
| Press-freedom / regulation across nations | Distributed sourcing; diversify markets; legal review per market |
| Content sourcing & rights | Aggregation now → original reporting as we fund editorial |
| Single-founder / key-person | First hires are editorial + engineering; documented, tested codebase |
| Monetization timing | Multiple revenue lines; low burn (infra ≈ cents/day) extends runway |
